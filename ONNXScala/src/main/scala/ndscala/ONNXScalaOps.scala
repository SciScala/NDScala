...
//  def reshape[DType <: Supported : ClassTag: Numeric](arr: Tensor[DType], newShape: Array[Int])(using tt: ValueOf[Tt], td: TensorShapeDenotationOf[Td], s: ShapeOf[S]): Tensor[DType] 
  ...
  extension[DType <: NumericSupported : ClassTag : Numeric:  IsNumericSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Shape]  (arr: Tensor[DType, (Tt,Td,S)]) def pad[Tt2 <: TensorTypeDenotation, AxesBefore <: Indices, AxesAfter <: Indices](constantValue: DType)(using tt: ValueOf[Tt2], td: TensorShapeDenotationOf[Td], s2: ShapeOf[PaddedShape[S,AxesBefore,AxesAfter]], i: IndicesOf[AxesBefore], i2: IndicesOf[AxesAfter]): Tensor[DType, (Tt2,Td,PaddedShape[S,AxesBefore,AxesAfter])] = onnx.PadV11("pad", mode = "constant", arr, indicesOf[AxesBefore], indicesOf[AxesAfter], Some(Tensor(Array(constantValue), tt.value, td.value, SNil)))
  extension[DType <: Supported : ClassTag : IsSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Shape]  (arr: Tensor[DType, (Tt,Td,S)]) def tile[Tt2 <: TensorTypeDenotation, AxisRepeats <: Indices](using tt: ValueOf[Tt2], td: TensorShapeDenotationOf[Td], s2: ShapeOf[TiledShape[S, AxisRepeats]], i: IndicesOf[AxisRepeats]): Tensor[DType, (Tt2,Td,TiledShape[S, AxisRepeats])] = onnx.TileV6("tile", arr, indicesOf[AxisRepeats])

  extension[DType <: Supported : ClassTag : IsSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Shape]  (arr: Tensor[DType, (Tt,Td,S)]) def shape[Tt2 <: TensorTypeDenotation, Td2 <: TensorShapeDenotation](using tt: ValueOf[Tt2], td: TensorShapeDenotationOf[Td2], s2: ShapeOf[io.kjaer.compiletime.Shape.Rank[S] & Dimension #: SNil]): Tensor[Long, (Tt2,Td2,io.kjaer.compiletime.Shape.Rank[S] & Dimension #: SNil)] = onnx.ShapeV1[DType,Long, Tt,Td, S, Tt2, Td2]("shape", arr)
  ...
  extension[DType <: FloatSupported : ClassTag: Numeric : IsFloatSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Shape](arr: Seq[Tensor[DType, (Tt,Td,S)]]) def ndsum()(using tt: ValueOf[Tt], td: TensorShapeDenotationOf[Td], s: ShapeOf[S]): Tensor[DType, (Tt,Td,S)] = onnx.SumV8("sum", arr)
...
//TODO: test
  ...
  extension[DType <: FloatSupported : ClassTag: Numeric : IsFloatSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Dimension #: Dimension #: Dimension #: Dimension #: SNil, S1 <: Dimension #: Dimension #: SNil] (arr: Tensor[DType, (Tt,Td,S)]) def averagePool(kernelShape: S1)(using tt: ValueOf[Tt], td: TensorShapeDenotationOf[Td], s: ShapeOf[PoolShape[S,S1]]): Tensor[DType, (Tt,Td,PoolShape[S,S1])] = onnx.AveragePoolV10("avgpool", X = arr, kernel_shape = kernelShape)
  extension[DType <: FloatSupported : ClassTag: Numeric : IsFloatSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Dimension #: Dimension #: Dimension #: Dimension #: SNil, S1 <: Dimension #: Dimension #: SNil] (arr: Tensor[DType, (Tt,Td,S)]) def maxPool(kernelShape: S1)(using tt: ValueOf[Tt], td: TensorShapeDenotationOf[Td], s: ShapeOf[PoolShape[S,S1]]): Tensor[DType, (Tt,Td,PoolShape[S,S1])] = onnx.MaxPoolV10("maxpool", X = arr, kernel_shape = kernelShape)
  ...
  extension[DType <: Supported : ClassTag : IsSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Shape] (arr: Tensor[DType, (Tt,Td,S)]) def ====(other: Tensor[DType, (Tt,Td,S)])(using tt: ValueOf[Tt], td: TensorShapeDenotationOf[Td], s: ShapeOf[S]): Tensor[Boolean, (Tt,Td,S)] = onnx.EqualV11[DType, Boolean, Tt,Td,S, Tt, Td]("eq", arr, other)
