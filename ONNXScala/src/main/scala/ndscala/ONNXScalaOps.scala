...
//  def reshape[DType <: Supported : ClassTag: Numeric](arr: Tensor[DType], newShape: Array[Int])(using tt: ValueOf[Tt], td: TensorShapeDenotationOf[Td], s: ShapeOf[S]): Tensor[DType] 
  ...
  extension[DType <: NumericSupported : ClassTag : Numeric:  IsNumericSupported, Tt <: TensorTypeDenotation, Td <: TensorShapeDenotation, S <: Shape]  (arr: Tensor[DType, (Tt,Td,S)]) def pad[Tt2 <: TensorTypeDenotation, AxesBefore <: Indices, AxesAfter <: Indices](using tt: ValueOf[Tt2], td: TensorShapeDenotationOf[Td], s2: ShapeOf[PaddedShape[S,AxesBefore,AxesAfter]], i: IndicesOf[AxesBefore], i2: IndicesOf[AxesAfter]): Tensor[DType, (Tt2,Td,PaddedShape[S,AxesBefore,AxesAfter])] = onnx.PadV11("pad", mode = "constant", arr, indicesOf[AxesBefore], indicesOf[AxesAfter])
