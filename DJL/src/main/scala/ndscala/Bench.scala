...
val x: DJLNDArray[Float, Axes] = (arrX, Array(10000,10000))
val y: DJLNDArray[Float, Axes]  = (arrY, Array(10000,1))

//TODO: call recursively

val w0: DJLNDArray[Float, Axes] = (arrW0, Array(10000,10000))
val w1: DJLNDArray[Float, Axes] = (arrW1, Array(10000,1))

val one: DJLNDArray[Float, Axes] = (Array(1.0f), Array(1))
