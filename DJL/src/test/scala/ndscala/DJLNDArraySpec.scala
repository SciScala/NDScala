...
// TODO: Don't do this, it silences match errors
  ...
  "DJLNDArray" should "add" in {
    val arr: DJLNDArray[Int, Axes] = (Array(42, 84), Array(1,2))
    doAssert(((arr:DJLNDArray[Int, Axes]) + (arr:DJLNDArray[Int, Axes])) ==== (Array(84, 168), Array(1,2)))
  }

  "DJLNDArray" should "subtract" in {
    val arr: DJLNDArray[Int, Axes] = (Array(42, 84), Array(1,2))
    doAssert(((arr: DJLNDArray[Int, Axes]) - (arr: DJLNDArray[Int, Axes])) ==== (Array(0, 0), Array(1,2)))
  }

  "DJLNDArray" should "multiply" in {
    val arr: DJLNDArray[Int, Axes] = (Array(42, 84), Array(1,2))
    doAssert(((arr: DJLNDArray[Int, Axes]) * (arr: DJLNDArray[Int, Axes])) ==== (Array(1764, 7056), Array(1,2)))
  }

  //TODO: weirdness here with Int
  "DJLNDArray" should "divide" in {
    val arr: DJLNDArray[Float, Axes] = (Array(42.0f, 84.0f), Array(1,2))
    doAssert(((arr: DJLNDArray[Float, Axes]) / (arr: DJLNDArray[Float, Axes])) ==== (Array(1.0f, 1.0f), Array(1,2)))
  }
  ...
  "DJLNDArray" should "transpose" in {
    val arr: DJLNDArray[Int, Axes] = (Array(1, 2, 3, 4), Array(2,2))
  ...
  "DJLNDArray" should "round" in {
    val arr: DJLNDArray[Double, Axes] = (Array(41.7, 84.3), Array(1,2))
    doAssert((arr.round()) ==== (Array(42.0, 84.0), Array(1,2)))
  }

  "DJLNDArray" should "slice" in {
    val arr: DJLNDArray[Int, Axes] = (Array(1, 2, 3, 4), Array(4))
...
*/
  "DJLNDArray" should "unary subtract" in {
    val arr: DJLNDArray[Int, Axes] = (Array(42, 84), Array(1,2))
    doAssert((- (arr:DJLNDArray[Int, Axes])) ==== (Array(-42, -84), Array(1,2)))
  }
  ...
  "DJLNDArray" should "ceil" in {
    val arr: DJLNDArray[Float, Axes] = (Array(-1.5f, 1.2f), Array(1,2))
  ...
  "DJLNDArray" should "log" in {
    val arr: DJLNDArray[Float, Axes] = (Array(1.0f, 10.0f), Array(1,2))
    doAssert((arr.log()) ==== (Array(0.0f, 2.30258512f), Array(1,2)))
  }

  "DJLNDArray" should "exp" in {
    val arr: DJLNDArray[Double, Axes] = (Array(-1.0, 0.0, 1.0), Array(1,3))
    val exp = arr.exp()
...
*/
  "DJLNDArray" should "sqrt" in {
    val arr: DJLNDArray[Double, Axes] = (Array(1.0, 4.0, 9.0), Array(1,3))
    doAssert((arr.sqrt()) ==== (Array(1.0, 2.0, 3.0), Array(1,3)))
  }

  "DJLNDArray" should "cos" in {
    val arr: DJLNDArray[Float, Axes] = (Array(-1.0f, 0.0f, 1.0f), Array(1,3))
    val result = arr.cos()
    println(result._1(0))
    println(result._1(1))
    println(result._1(2))
    doAssert((result:DJLNDArray[Float, Axes]) ==== (Array(0.5403023f, 1.0f, 0.5403023f), Array(1,3)))
  }
  ...
  "DJLNDArray" should "atanh" in {
    val arr: DJLNDArray[Float, Axes] = (Array(-0.5f, 0.0f, 0.5f), Array(1,3))
  ...
  "DJLNDArray" should "pow" in {
    val arr: DJLNDArray[Double, Axes] = (Array(42.0, 84.0), Array(1,2))
  ...
  "DJLNDArray" should "gte" in {
    val arr: DJLNDArray[Long, Axes] = (Array(42l, 84l), Array(1,2))
  ...
  "DJLNDArray" should "matmul" in {
    val arr: DJLNDArray[Double, Axes] = (Array(42.0, 84.0), Array(1,2))
    val other: DJLNDArray[Double, Axes] = (Array(42.0, 84.0), Array(2,1))
    val result = (((arr: DJLNDArray[Double, Axes]) matmul (other: DJLNDArray[Double, Axes])) ==== (Array(8820.0), Array(1,1)))
    doAssert(result)
  }
}
