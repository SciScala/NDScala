...
// TODO: Don't do this, it silences match errors
  ...
  "Tensor" should "add" in {
    val arr: Tensor[Int] = (Array(42, 84), Mat(1,2))
    doAssert(((arr + arr) ====(Array(84, 168), Mat(1,2))))
  }

  "Tensor" should "subtract" in {
    val arr: Tensor[Int] = (Array(42, 84), Mat(1,2))
    doAssert((arr - arr) ==== (Array(0, 0), Mat(1,2)))
  }

  "Tensor" should "multiply" in {
    val arr: Tensor[Int] = (Array(42, 84), Mat(1,2))
    doAssert((arr * arr) ==== (Array(1764, 7056), Mat(1,2)))
  }

  "Tensor" should "divide" in {
    val arr: Tensor[Int] = (Array(42, 84), Mat(1,2))
    doAssert((arr / arr) ==== (Array(1, 1), Mat(1,2)))
  }
  ...
  "Tensor" should "transpose" in {
    val arr: Tensor[Int] = (Array(1, 2, 3, 4), Mat(2,2))
  ...
  "Tensor" should "round" in {
    val arr: Tensor[Double] = (Array(41.7, 84.3), Mat(1,2))
    doAssert((arr.round()) ==== (Array(42.0, 84.0), Mat(1,2)))
  }

  "Tensor" should "slice" in {
    val arr: Tensor[Int] = (Array(1, 2, 3, 4), Vec(4))
...
*/
  ...
  "Tensor" should "ceil" in {
    val arr: Tensor[Float] = (Array(-1.5f, 1.2f), Mat(1,2))
  ...
  "Tensor" should "log" in {
    val arr: Tensor[Float] = (Array(1.0f, 10.0f), Mat(1,2))
    doAssert((arr.log()) ==== (Array(0.0f, 2.30258512f), Mat(1,2)))
  }

  "Tensor" should "exp" in {
    val arr: Tensor[Double] = (Array(-1.0, 0.0, 1.0), Mat(1,3))
    val exp = arr.exp()
...
*/
  ...
  "Tensor" should "cos" in {
    val arr: Tensor[Float] = (Array(-1.0f, 0.0f, 1.0f), Mat(1,3))
    doAssert((arr.cos()) ==== (Array(0.5403023f, 1.0f, 0.5403023f), Mat(1,3)))
  }
  ...
  "Tensor" should "atanh" in {
    val arr: Tensor[Float] = (Array(-0.5f, 0.0f, 0.5f), Mat(1,3))
  ...
  "Tensor" should "gte" in {
    val arr: Tensor[Long] = (Array(42l, 84l), Mat(1,2))
  ...
  "Tensor" should "matmul" in {
    val arr: Tensor[Double] = (Array(42.0, 84.0), Mat(1,2))
    val other: Tensor[Double] = (Array(42.0, 84.0), Mat(2,1))
